...
public class BookingMapper {
    ...
    public Booking toEntity(BookingRequest request, Passenger passenger, Driver driver) {
        ...
        return Booking.builder()
                .passenger(passenger)
                .driver(driver)
                .pickupLocationLatitude(Double.parseDouble(request.getPickupLocationLatitude().toString()))
                .pickupLocationLongitude(Double.parseDouble(request.getPickupLocationLongitude().toString()))
    ...
    public BookingResponse toResponse(Booking booking) {
        return BookingResponse.builder()
                ...
                .pickupLocationLatitude(Double.parseDouble(String.valueOf(booking.getPickupLocationLatitude())))
                .pickupLocationLongitude(Double.parseDouble(String.valueOf(booking.getPickupLocationLongitude())))
    ...
    public void updateEntity(Booking booking, BookingRequest request, Passenger passenger, Driver driver) {
        ...
        booking.setPickupLocationLatitude(Double.parseDouble(request.getPickupLocationLatitude().toString()));
        booking.setPickupLocationLongitude(Double.parseDouble(request.getPickupLocationLongitude().toString()));
