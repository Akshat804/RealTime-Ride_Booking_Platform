...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingResponse create(BookingRequest request) {
        ...
        Booking newBooking = Booking.builder()
                .passenger(passenger)
                .driver(driver)
                .pickupLocationLatitude(Double.parseDouble(pickupLat))
                .pickupLocationLongitude(Double.parseDouble(pickupLng))
        ...
        List<DriverLocationDTO> nearbyDrivers = locationService.getNearbyDrivers(Double.parseDouble(pickupLat), Double.parseDouble(pickupLng), 6000.0);
